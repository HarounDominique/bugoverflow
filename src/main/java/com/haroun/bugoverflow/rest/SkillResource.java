...
public class SkillResource {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SkillDTO> getSkill(@PathVariable(name = "id") final Long id) {
    ...
    public ResponseEntity<Long> createSkill(@RequestBody @Valid final SkillDTO skillDTO) {
        final Long createdId = skillService.create(skillDTO);
        return new ResponseEntity<>(createdId, HttpStatus.CREATED);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Long> updateSkill(@PathVariable(name = "id") final Long id,
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteSkill(@PathVariable(name = "id") final Long id) {
