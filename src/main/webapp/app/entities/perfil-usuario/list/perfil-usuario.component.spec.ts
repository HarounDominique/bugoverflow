...
import { sampleWithRequiredData } from '../perfil-usuario.test-samples';
...
describe('PerfilUsuario Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.perfilUsuarios()[0]).toEqual(expect.objectContaining({ id: 8289 }));
  });

  describe('trackId', () => {
    it('should forward to perfilUsuarioService', () => {
      const entity = { id: 8289 };
      jest.spyOn(service, 'getPerfilUsuarioIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPerfilUsuarioIdentifier).toHaveBeenCalledWith(entity);
